...
Meta_Prompt_React = """
Given a task description or existing prompt, produce a detailed system prompt with available tools(if applicable) to guide LLM in completing the task effectively.
...
print(
    generate_prompt(
        "你是一个 deep researcher。忘记你之前的知识，只通过 web_search 和 web_crawl 工具获取外部知识，并根据工具的返回值总结出报告。"
    )
)
